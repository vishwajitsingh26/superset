...
> {
  constructor() {
    const metadata = new ChartMetadata({
      ...
      category: t('KPI'),
      description: t(
        'A spend card composing a headline value, a signed change pair, a share and rate sub-line, a period sparkline, a top cost driver strip, a last-updated stamp and an outbound link.',
      ),
      name: t('Custom Provider Spend Card'),
      tags: [t('KPI'), t('Trend'), t('CloudKeeper'), t('Card')],
      thumbnail,
      useLegacyApi: false,
