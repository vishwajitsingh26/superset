...
//
// Extended from the seeded version with `validateNonEmpty` and
// `ControlPanelState`, needed by this plugin's controlPanel; every export
// the seed already declared is kept unchanged.
import {
  Behavior,
  ChartMetadata,
  ChartPlugin,
