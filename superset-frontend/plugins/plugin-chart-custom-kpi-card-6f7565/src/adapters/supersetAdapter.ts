...
//
// Seeded, not owned: extended here with `validateNonEmpty`, which
// `controlPanel.ts` needs to require the headline metric. Every symbol the
// skeleton originally exported is kept, so nothing that already imports from
// this file breaks.
import {
  Behavior,
  ChartMetadata,
